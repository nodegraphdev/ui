...
static int ng_texture_format_lookup[][3] = {
  ...
  // Internal, Layout,  Size
    ...
    {GL_RG16UI, GL_RG_INTEGER,   GL_UNSIGNED_SHORT }, // NG_TEXTURE_FORMAT_RG16UI
    {GL_R16UI,  GL_RED_INTEGER,  GL_UNSIGNED_SHORT }, // NG_TEXTURE_FORMAT_R16UI
    {GL_R16I,   GL_RED_INTEGER,  GL_SHORT          }, // NG_TEXTURE_FORMAT_R16I
};
